...
class GameEnv:
    ...
    *** Note that evaluation on GradeScope will use an unmodified GameEnv instance as a simulator - unlike previous
    assignments, this rule will be in effect for assignment 3 ***
    """
